...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	    ...
	    handleStateChange: function handleStateChange(city) {
	        var that = this;
	        this.setState({
	            isLoading: true
	        });
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(WeatherForm, { onNewCity: this.handleStateChange }),
	            renderMessage()
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://samples.openweathermap.org/data/2.5/weather?appid=4c50153c429864970a23fd419a10233e&units=imperial';
